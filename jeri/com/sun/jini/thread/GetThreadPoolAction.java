/* 
 * This file has been changed since taken from their original authors
 * to use a different thread pool for server connections.
 *  
 * */
...
public final class GetThreadPoolAction implements PrivilegedAction {
     ...
     * We assign here a default value, but note that the field is public and
     * non-final. In the server setup we override the value here.
     * */
    public static Executor systemThreadPool = new Executor(){
     ...
     * non-final. In the server setup we override the value here.
     * */
    public static Executor userThreadPool = systemThreadPool;
